...
export const LESSONS: LessonMeta[] = [
  ...
  },
  {
    ...
    objectives: [
      ...
      'Z1000·Z2000·Z3000·Z4xxx·Z5000 등 주요 코드의 역할을 구분한다',
      'Z코드 금액이 점수 × 환산지수(2026년 105.5원)로 산출되는 suga_fee 조회 흐름을 설명할 수 있다',
    ],
  },
  {
  ...
  },
  {
    ...
    objectives: [
      ...
      '산정특례(중증·희귀질환)가 본인부담률을 어떻게 낮추는지 설명할 수 있다 (V252는 별도 경증질환 차등제로 구분)',
